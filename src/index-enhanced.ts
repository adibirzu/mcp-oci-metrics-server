...
let mqlEngine: MQLQueryEngine;
let templateEngine: TemplateVariableEngine;
...
// Enhanced tool handlers
async function handleManageDatasourceConfig(args: any) {
  ...
  switch (action) {
    ...
    case 'test':
      if (!tenancyId) throw new Error('tenancyId required for test action');
    ...
    case 'set_default':
      if (!tenancyId) throw new Error('tenancyId required for set_default action');
...
async function handleQueryMQL(args: any) {
...
async function handleValidateMQL(args: any) {
...
async function handleGetMQLSuggestions(args: any) {
...
async function handleManageTemplateVariables(args: any) {
  ...
  switch (action) {
    ...
    case 'resolve':
      if (!queryString) throw new Error('queryString required for resolve action');
    ...
    case 'add':
      if (!variableConfig) throw new Error('variableConfig required for add action');
...
async function handleManageAuthentication(args: any) {
  ...
  switch (action) {
    ...
    case 'test':
      if (!identifier) throw new Error('identifier required for test action');
...
async function handleQueryWithTemplate(args: any) {
...
async function handleQueryCrossTenancy(args: any) {
  const results = [];
...
async function handleExportConfiguration(args: any) {
  const config = {
  ...
  if (!args.includeSecrets) {
    ...
    delete (config.authentication as any).keyFile;
    delete (config.authentication as any).fingerprint;
  }
...
async function handleImportConfiguration(args: any) {
  try {
...
async function handleEnhancedQueryMetrics(args: any) {
...
async function handleEnhancedGenerateGraph(args: any) {
...
async function handleEnhancedTestConnection(args: any) {
  let results;
